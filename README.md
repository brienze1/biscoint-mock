...
1. [About the Project](#about-the-project)
    1. [Input](#input)
        1. [Create Offer](#create-offer-input)
        2. [Confirm Offer](#confirm-offer-input)
        3. [Get Balance](#get-balance-input)
        4. [Generate Token](#generate-token-input)
    2. [Output](#output)
        1. [Create Offer](#create-offer-output)
        2. [Confirm Offer](#confirm-offer-output)
        3. [Get Balance](#get-balance-output)
        4. [Generate Token](#generate-token-output)
    3. [Rules](#rules)
...
The output generated by calling `v1/balance` can be seen bellow.

- BRL: current client balance for BRL
- BTC: current client balance for BTC
